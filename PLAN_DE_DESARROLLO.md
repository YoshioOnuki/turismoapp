...
- [ ] Revisar los RNF: consultas principales indexadas para tiempos de respuesta (RNF-05, RNF-07); HTTPS (RNF-13) y respaldo diario con siete copias (RNF-10) pendientes de infraestructura.
